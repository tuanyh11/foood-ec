...
const Login = ({ login }) => {
  ...
  return (
    <div className="relative w-full bg-no-repeat pt-[100vh] bg-cover " style={{backgroundImage: `url(${'https://live.staticflickr.com/65535/50813570567_f69b84c427_b.jpg'})`}} >

        <div className="bg-white rounded-md absolute top-1/2 left-1/2 w-full md:w-auto -translate-y-[50%] -translate-x-1/2 z-[999999]">
          <div className="flex items-center  justify-center p-12 shadow-lg">
            <div className="mx-auto  md:w-[550px]">
              ...
              >
                ...
                <div className="hover:shadow-form hover:text-main mt-8 grid grid-cols-2 md:grid-cols-2 gap-4 justify-between ">
                  <Link to={"/register"}>
                    Don't have acount?{" "}
                  ...
                  <Link to={"/"}>
                   Go <span className="font-bold text-xl">Home </span>
                </Link>
                </div>
